...
import 'package:flutter_provider/feature/home/view_model/main_vm.dart';
...
class _HomePageState extends ConsumerState<HomePage> {
  HomeNotifier mainVM = HomeNotifier();
      ...
      body: Consumer(
        builder: (context, ref, _) {
          ...
          return GridView.builder(
            ...
            itemCount: ref.read(homeRef.notifier).users.length,
              ...
              return InkWell(
                onLongPress: () async {
                  await NetworkService.DELETE(
                      NetworkService.apiPosts, ref.read(homeRef.notifier).users[index].id!);
                  setState(() {});
                },
                onTap: () {
                    ...
                    child: Column(
                      ...
                      children: [
                        Expanded(
                          child: Center(
                            child: Text(
                              ref.read(homeRef.notifier).users[index].firstName ?? "",
                        ...
                        Container(
                          child: Center(
                            child: Text(
                              ref.read(homeRef.notifier).users[index].username ?? "",
                              style: const TextStyle(
